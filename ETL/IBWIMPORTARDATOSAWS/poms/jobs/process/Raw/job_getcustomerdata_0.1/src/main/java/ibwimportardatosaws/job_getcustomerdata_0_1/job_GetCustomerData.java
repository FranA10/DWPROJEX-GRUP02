...
public class job_GetCustomerData implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XnsdUmuH+1OyLNoD6K3hoh8y4OCeovJn0txPJu83He30ayOZtmRee5Xte7u8htRqEQIdIyzl2g1bo/J4TnaxTad3MTg=");

				com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials(
						"AKIAWPQYH5GKGRDBIMFA", decryptedPassword_tS3Connection_1);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"bucket-grupo2", "01 raw/tabCustomer.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1,
							new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabCustomer.csv"), null, 0l, true);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_GetCustomerData.class.getClassLoader().getResourceAsStream(
					"ibwimportardatosaws/job_getcustomerdata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_GetCustomerData.class.getClassLoader()
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("FAccessKey")) {
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetCustomerData");
		}
...
/************************************************************************************************
 * 41693 characters generated by Talend Open Studio for Data Integration on the
 * 14 de noviembre de 2023, 23:46:34 CST
 ************************************************************************************************/