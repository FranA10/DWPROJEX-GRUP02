...
package ibwimportardatosaws.job_getcustomerdata_0_1;
...
/**
 * Job: job_GetCustomerData Purpose: obtener data de row<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class job_GetCustomerData implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(FAccessKey != null){
					...
					this.setProperty("FAccessKey", FAccessKey.toString());
				
			}
			
			if(FSecertKey != null){
				
					this.setProperty("FSecertKey", FSecertKey.toString());
				
			}
			
			if(NBucket != null){
				
					this.setProperty("NBucket", NBucket.toString());
...
public String FAccessKey;
public String getFAccessKey(){
	return this.FAccessKey;
}
public String FSecertKey;
public String getFSecertKey(){
	return this.FSecertKey;
}
public String NBucket;
public String getNBucket(){
	return this.NBucket;
}
	}
	...
	private final String jobName = "job_GetCustomerData";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_GetCustomerData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_GetCustomerData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabCustomer.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabCustomer.csv");
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:h2Ic4mjbCGLPxtQNCJIjLWmq/B6QtEK/vt3Q+KwMz4tTo27ygxgmeLzm4n0F3fAT+9nw22t2/Exe7DogoCXeCsd/hWc=");

            com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials("AKIAWPQYH5GKGRDBIMFA",decryptedPassword_tS3Connection_1);
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("bucket-grupo2", "01 raw/tabCustomer.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabCustomer.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final job_GetCustomerData job_GetCustomerDataClass = new job_GetCustomerData();

        int exitCode = job_GetCustomerDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_GetCustomerData.class.getClassLoader().getResourceAsStream("ibwimportardatosaws/job_getcustomerdata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_GetCustomerData.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("FAccessKey", "id_String");
                        if(context.getStringValue("FAccessKey") == null) {
                            context.FAccessKey = null;
                        } else {
                            context.FAccessKey=(String) context.getProperty("FAccessKey");
                        }
                        context.setContextType("FSecertKey", "id_String");
                        if(context.getStringValue("FSecertKey") == null) {
                            context.FSecertKey = null;
                        } else {
                            context.FSecertKey=(String) context.getProperty("FSecertKey");
                        }
                        context.setContextType("NBucket", "id_String");
                        if(context.getStringValue("NBucket") == null) {
                            context.NBucket = null;
                        } else {
                            context.NBucket=(String) context.getProperty("NBucket");
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("FAccessKey")) {
                context.FAccessKey = (String) parentContextMap.get("FAccessKey");
            }if (parentContextMap.containsKey("FSecertKey")) {
                context.FSecertKey = (String) parentContextMap.get("FSecertKey");
            }if (parentContextMap.containsKey("NBucket")) {
                context.NBucket = (String) parentContextMap.get("NBucket");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetCustomerData");
        }
...
/************************************************************************************************
 *     41693 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 de noviembre de 2023, 22:21:17 CST
 ************************************************************************************************/