...
package ibwimportardatosaws.job_getitemdata_0_1;
...
/**
 * Job: job_GetItemData Purpose: obtener data de row<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class job_GetItemData implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_GetItemData";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_GetItemData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_GetItemData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabItem.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabItem.csv");
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:E3uYWu9JNb5KpYdm4JyrHBeJGtuoES47GXnCfjSyQB9SeOAX7TClvvnHcFhWk507a/NOfPQIOOEhiBH9aM2db1dzphw=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("bucket-grupo2", "01 raw/tabItem.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabItem.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final job_GetItemData job_GetItemDataClass = new job_GetItemData();

        int exitCode = job_GetItemDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_GetItemData.class.getClassLoader().getResourceAsStream("ibwimportardatosaws/job_getitemdata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_GetItemData.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetItemData");
        }
...
/************************************************************************************************
 *     39539 characters generated by Talend Open Studio for Data Integration 
