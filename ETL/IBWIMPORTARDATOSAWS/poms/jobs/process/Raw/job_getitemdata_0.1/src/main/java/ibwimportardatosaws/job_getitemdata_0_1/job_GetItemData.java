...
public class job_GetItemData implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileDelete_1 = new java.io.File(
						"C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabItem.csv");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:pvr5Z3V6DH/iSH7qWZ5A/LcsJhaoaPRTp7+SPjCpNf9MosWMdYq96xtGJImGXWeaUx5mJPFVZIKJaFTjxFoNSC+PXiU=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"bucket-grupo2", "01 raw/tabItem.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1,
							new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabItem.csv"), null, 0l, true);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_GetItemData.class.getClassLoader().getResourceAsStream(
					"ibwimportardatosaws/job_getitemdata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_GetItemData.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetItemData");
		}
...
/************************************************************************************************
 * 39539 characters generated by Talend Open Studio for Data Integration on the
 * 29 de noviembre de 2023, 0:01:37 CST
 ************************************************************************************************/