...
package ibwimportardatosaws.job_getaddressdata_0_1;
...
/**
 * Job: job_GetAddressData Purpose: obtener data cruda<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class job_GetAddressData implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_GetAddressData";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_GetAddressData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_GetAddressData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabAddress.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabAddress.csv");
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:maK4NbP8tOaGqMkoEVTtmRnNC1GhJIE+TL1vFHjmM8uiVI8fooGD9FCIShPdNr+YibkiSamdavbF/Ayy8/IXUtDchVI=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("bucket-grupo2", "01 raw/tabAddress.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/tabAddress.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final job_GetAddressData job_GetAddressDataClass = new job_GetAddressData();

        int exitCode = job_GetAddressDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_GetAddressData.class.getClassLoader().getResourceAsStream("ibwimportardatosaws/job_getaddressdata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_GetAddressData.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetAddressData");
        }
...
/************************************************************************************************
 *     39592 characters generated by Talend Open Studio for Data Integration 
