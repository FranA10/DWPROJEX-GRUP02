	...
	public void tFileDelete_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("tFileDelete_1_DELETE_PATH", "C:/Users/Fran/Desktop/IBW-Proyecto/Raw/factura.csv");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qur1QI9FWtVbHv+ctRrdKrjddiYGiMwaOhcZjSBGfqNvABa4Tj9K2K9cjdqXFlgDjycPN0Iq81IN7YzbClM8Pr4lhbg=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							...
							new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/factura.csv"), null, 0l, true);
...
/************************************************************************************************
 * 39585 characters generated by Talend Open Studio for Data Integration on the
 * 15 de noviembre de 2023, 17:21:04 CST
 ************************************************************************************************/