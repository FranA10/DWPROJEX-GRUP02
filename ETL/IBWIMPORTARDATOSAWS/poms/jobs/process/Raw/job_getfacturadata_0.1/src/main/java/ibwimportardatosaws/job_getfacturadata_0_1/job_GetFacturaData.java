...
public class job_GetFacturaData implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:zG4zNijCoZFezg8pp2zS1ccRXxcXuj/mMubFEv2wRUaRYBdXn5iK1XbiG9heJ85BQtIiOfeHnOHILZ3bChvy1IwJT9M=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"bucket-grupo2", "01 raw/facturas.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1,
							new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/facturas.csv"), null, 0l, true);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_GetFacturaData.class.getClassLoader().getResourceAsStream(
					"ibwimportardatosaws/job_getfacturadata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_GetFacturaData.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetFacturaData");
		}
...
/************************************************************************************************
 * 39588 characters generated by Talend Open Studio for Data Integration on the
 * 28 de noviembre de 2023, 22:58:17 CST
 ************************************************************************************************/