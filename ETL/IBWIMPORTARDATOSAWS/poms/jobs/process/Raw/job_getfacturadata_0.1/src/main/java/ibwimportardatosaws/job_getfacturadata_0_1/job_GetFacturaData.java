...
package ibwimportardatosaws.job_getfacturadata_0_1;
...
/**
 * Job: job_GetFacturaData Purpose: obtener la data de row<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class job_GetFacturaData implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_GetFacturaData";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_GetFacturaData.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_GetFacturaData.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/facturas.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","C:/Users/Fran/Desktop/IBW-Proyecto/Raw/facturas.csv");
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wXdSlxmMkKoOapyB4YiGWyb/xZRU+UvIWbKMs595rMuUkPf4gia6FB5Yx43Ms+52kpnKO3duYsQswz3i8bt3KoTo6aQ=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("bucket-grupo2", "01 raw/facturas.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File("C:/Users/Fran/Desktop/IBW-Proyecto/Raw/facturas.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final job_GetFacturaData job_GetFacturaDataClass = new job_GetFacturaData();

        int exitCode = job_GetFacturaDataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_GetFacturaData.class.getClassLoader().getResourceAsStream("ibwimportardatosaws/job_getfacturadata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_GetFacturaData.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_GetFacturaData");
        }
...
/************************************************************************************************
 *     39588 characters generated by Talend Open Studio for Data Integration 
