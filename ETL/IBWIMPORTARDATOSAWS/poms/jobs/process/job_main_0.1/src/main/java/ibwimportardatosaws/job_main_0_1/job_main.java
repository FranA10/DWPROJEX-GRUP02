...
package ibwimportardatosaws.job_main_0_1;
...
/**
 * Job: job_main Purpose: job principal de datos<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class job_main implements TalendJob {
	...
	private final String jobName = "job_main";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_main.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_getaddressdata_0_1.job_GetAddressData childJob_tRunJob_1 = new ibwimportardatosaws.job_getaddressdata_0_1.job_GetAddressData();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_getcustomerdata_0_1.job_GetCustomerData childJob_tRunJob_2 = new ibwimportardatosaws.job_getcustomerdata_0_1.job_GetCustomerData();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_getfechadata_0_1.job_GetFechaData childJob_tRunJob_4 = new ibwimportardatosaws.job_getfechadata_0_1.job_GetFechaData();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_getfacturadata_0_1.job_GetFacturaData childJob_tRunJob_3 = new ibwimportardatosaws.job_getfacturadata_0_1.job_GetFacturaData();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_getitemdata_0_1.job_GetItemData childJob_tRunJob_5 = new ibwimportardatosaws.job_getitemdata_0_1.job_GetItemData();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk1", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk2", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk3", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk4", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_transform_dimproducto_0_1.job_Transform_DimProducto childJob_tRunJob_6 = new ibwimportardatosaws.job_transform_dimproducto_0_1.job_Transform_DimProducto();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_transform_dimdireccion_0_1.job_Transform_DimDireccion childJob_tRunJob_7 = new ibwimportardatosaws.job_transform_dimdireccion_0_1.job_Transform_DimDireccion();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_transform_dimcustomer_0_1.job_Transform_DimCustomer childJob_tRunJob_8 = new ibwimportardatosaws.job_transform_dimcustomer_0_1.job_Transform_DimCustomer();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_fecha_0_1.job_fecha childJob_tRunJob_9 = new ibwimportardatosaws.job_fecha_0_1.job_fecha();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_cliente_0_1.job_cliente childJob_tRunJob_10 = new ibwimportardatosaws.job_cliente_0_1.job_cliente();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_direccion_0_1.job_direccion childJob_tRunJob_11 = new ibwimportardatosaws.job_direccion_0_1.job_direccion();
				// pass DataSources
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_producto_0_1.job_producto childJob_tRunJob_12 = new ibwimportardatosaws.job_producto_0_1.job_producto();
				// pass DataSources
	...
	public void tRunJob_13Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_transform_factfactura_0_1.job_Transform_FactFactura childJob_tRunJob_13 = new ibwimportardatosaws.job_transform_factfactura_0_1.job_Transform_FactFactura();
				// pass DataSources
	...
	public void tRunJob_14Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ibwimportardatosaws.job_factura_0_1.job_factura childJob_tRunJob_14 = new ibwimportardatosaws.job_factura_0_1.job_factura();
				// pass DataSources
	...
	public static void main(String[] args) {
		final job_main job_mainClass = new job_main();

		int exitCode = job_mainClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_main.class.getClassLoader()
					.getResourceAsStream("ibwimportardatosaws/job_main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_main.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_main");
		}
...
/************************************************************************************************
 * 122156 characters generated by Talend Open Studio for Data Integration on the
 * 28 de enero de 2024, 10:23:50 CST
 ************************************************************************************************/